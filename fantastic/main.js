...
function populate() {
	...
	for (var i = 0; i < 7; i++) {
		...
		part.add(new _base.Line([x + i * lineWidth, y], [endX + i * lineWidth, endY], i % 2 === 0 ? color : backColor, lineWidth, startTime, duration));
	}
	...
	for (var _i = 0; _i < 7; _i++) {
		startTime = startTime + duration / 7;
		part.add(new _base.Line([x, y + 1 + _i * lineWidth * 1.5], [endX + 1 + _i * lineWidth * 1.5, endY], _i % 2 === 0 ? color : backColor, lineWidth, startTime, duration));
	}
	...
	for (var _i2 = 0; _i2 < 7; _i2++) {
		startTime = startTime + duration / 7;
		part.add(new _base.Line([x, y + _i2 * lineWidth], [endX, endY + _i2 * lineWidth], _i2 % 2 === 0 ? color : backColor, lineWidth, startTime, duration));
	}
	...
	for (var _i3 = 0, arc = null; _i3 < 4; _i3++) {
		...
		arc = new _base.Arc([width / 2, height / 2], lineLength / 2 + lineLength / 5 + _i3 * lineWidth * 2, -(Math.PI / 2), -2 * Math.PI, color, lineWidth, startTime, duration);
